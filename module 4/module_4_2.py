...
def test_function():
    ...
    inner_function()  # здесь ничего не выводится в терминал, так как функция ничего не возвращает

inner_function()  # здесь выдает ошибку, так как нельзя вызывать внутреннюю функцию (функцию внутри функции)
